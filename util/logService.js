...
function debug(msg) {
    if (DEBUG >= defaultLevel) {
        console.log("%c[%cDEBUG%c]%c[" + timestamp() + "]%c" + getStackTrace()[1] + "%c" + msg, COLOR_BLACK, COLOR_ORANGE, COLOR_BLACK, COLOR_BLUE, COLOR_BLACK, COLOR_GREEN);
    }
}
...
function info(msg) {
    if (INFO >= defaultLevel) {
        console.log("%c[%cINFO%c]%c[" + timestamp() + "]%c" + getStackTrace()[1] + "%c" + msg, COLOR_BLACK, COLOR_BLUE, COLOR_BLACK, COLOR_BLUE, COLOR_BLACK, COLOR_GREEN);
    }
}
...
function warn(msg) {
    if (WARN >= defaultLevel) {
        console.log("%c[%cWARN%c]%c[" + timestamp() + "]%c" + getStackTrace()[1] + "%c" + msg, COLOR_BLACK, COLOR_ORANGE, COLOR_BLACK, COLOR_BLUE, COLOR_ORANGE, COLOR_GREEN);
    }
}
...
function error(msg) {
    if (ERROR >= defaultLevel) {
        console.log("%c[%cERROR%c]%c[" + timestamp() + "]%c" + getStackTrace()[1] + "%c" + msg, COLOR_BLACK, COLOR_RED, COLOR_BLACK, COLOR_BLUE, COLOR_RED, COLOR_GREEN);
    }
}
...
function fatal(msg) {
    if (FATAL >= defaultLevel) {
        console.log("%c[%cTRACE%c]%c[" + timestamp() + "]%c" + getStackTrace()[1] + "%c" + msg, COLOR_BLACK, COLOR_RED, COLOR_BLACK, COLOR_BLUE, COLOR_BLACK, COLOR_GREEN);
    }
}
